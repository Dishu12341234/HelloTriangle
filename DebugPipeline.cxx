...
void DebugPipeline::createGraphicsPipeline()
{
    std::cout << "Creating Graphics Pipeline..." << std::endl;

    auto vertShaderCode = readFile("shaders/simple_shader_debug_v.spv");
    auto fragShaderCode = readFile("shaders/simple_shader_debug_f.spv");
